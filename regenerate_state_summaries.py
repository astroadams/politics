#!/usr/bin/env python3
"""
Regenerate state-level summary files with proper election data aggregation.
"""
...
def regenerate_state_summaries():
    """Regenerate state summary files with aggregated election data."""
    ...
    print("Regenerating state summaries with election data...")
    ...
    for state_dir in state_dirs:
        ...
        # Save updated state boundary
        state_file = state_dir / f"state_{state_fips}.geojson"
        state_boundary.to_file(state_file, driver='GeoJSON')
...
if __name__ == "__main__":
    success = regenerate_state_summaries()
    if success:
        print("State summaries regenerated successfully!")
    else:
        print("Failed to regenerate state summaries.")